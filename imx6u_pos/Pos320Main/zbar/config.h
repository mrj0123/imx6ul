...
/* Define for Solaris 2.5.1 so the u32 typedef from <sys/synch.h>,
   <pthread.h>, or <semaphore.h> is not used. If the typedef were allowed, the
   #define below would cause a syntax error. */
#undef _u32

/* Define for Solaris 2.5.1 so the u8 typedef from <sys/synch.h>,
   <pthread.h>, or <semaphore.h> is not used. If the typedef were allowed, the
   #define below would cause a syntax error. */
#undef _u8
...
/* Define to `_inline__' or `_inline' if that's what the C compiler
